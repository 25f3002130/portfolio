  ...
  class PointerHandler {
    ...
    constructor(element: HTMLCanvasElement, scale: number) {
      ...
      element.addEventListener('pointerdown', (e) => {
        ...
        this.pointers.set(e.pointerId, [(e.clientX - rect.left) * this.scale, (rect.height - (e.clientY - rect.top)) * this.scale]);
      });
      ...
      element.addEventListener('pointermove', (e) => {
        ...
        const rect = element.getBoundingClientRect();
        this.pointers.set(e.pointerId, [(e.clientX - rect.left) * this.scale, (rect.height - (e.clientY - rect.top)) * this.scale]);
        this.moves = [this.moves[0] + e.movementX * this.scale, this.moves[1] - e.movementY * this.scale];
      });
    }
              ...
              {trustBadge.icons && (
                <div className="flex gap-1">
                  {trustBadge.icons.map((icon, index) => {
                    const colors = ['text-yellow-300', 'text-orange-300', 'text-amber-300'];
                    return (
